...
- **Data, not code, for anything tunable.** The spellbook and voice presets are config, so editing them never touches the pipeline ([README.md:13](https://github.com/BoardPandas/Hark/blob/1c1738716fa4cd758b0c26ec94d0873d1bc35ac1/README.md#L13)).
...
| STT (cloud, primary) | BYOK cloud via an `SttProvider` trait: OpenAI-compatible `/audio/transcriptions` adapter (OpenAI, Groq) + Deepgram nova-3 adapter (`keyterm` biasing) | ([hark-stt/src/lib.rs:41](../crates/hark-stt/src/lib.rs#L41)) |
...
| Storage | `rusqlite` (history + stats); TOML (settings + spellbook) | ([README.md:30](https://github.com/BoardPandas/Hark/blob/1c1738716fa4cd758b0c26ec94d0873d1bc35ac1/README.md#L30), [CLAUDE.md:20](https://github.com/BoardPandas/Hark/blob/1c1738716fa4cd758b0c26ec94d0873d1bc35ac1/CLAUDE.md#L20)) |
...
| `hark-spellbook` | Phonetic post-correction + per-provider biasing terms ([README.md:107](https://github.com/BoardPandas/Hark/blob/1c1738716fa4cd758b0c26ec94d0873d1bc35ac1/README.md#L107)) |
...
| `hark-config` | TOML settings + spellbook load/save ([README.md:112](https://github.com/BoardPandas/Hark/blob/1c1738716fa4cd758b0c26ec94d0873d1bc35ac1/README.md#L112)) |
...
`config/` holds the default `config.toml` and spellbook shipped with the app ([README.md:116](https://github.com/BoardPandas/Hark/blob/1c1738716fa4cd758b0c26ec94d0873d1bc35ac1/README.md#L116)).
...
graph TD
    ...
    SttPost --> Spellbook["Phonetic Post-Correction"]
    Spellbook --> VoiceCheck{"Voice is Verbatim?"}
...
- The transcript is phonetically corrected against the spellbook; if the active voice is Verbatim the corrected text is injected as-is, otherwise a single low-temperature BYOK LLM call applies the voice template, spellbook terms, and transcript ([README.md:46-50](https://github.com/BoardPandas/Hark/blob/1c1738716fa4cd758b0c26ec94d0873d1bc35ac1/README.md#L46-L50)).
