...
The settings/history/stats window is a second, optional surface: a sidebar shell that routes between five egui pages (History, Spellbook, Invocations, Stats, Settings) plus a status footer and an update banner, and it can stay closed entirely while push-to-talk dictation keeps working from the tray ([ui/pages.rs:17-24](https://github.com/BoardPandas/Hark/blob/bcfcc3fef6f02252870fc3f06440d99992818ade/crates/hark-app/src/ui/pages.rs#L17-L24), [ui/shell.rs:179-184](https://github.com/BoardPandas/Hark/blob/bcfcc3fef6f02252870fc3f06440d99992818ade/crates/hark-app/src/ui/shell.rs#L179-L184)). A third, transient surface is the recording overlay: a borderless always-on-top pill shown only while the push-to-talk chord is held ([overlay.rs:1-18](https://github.com/BoardPandas/Hark/blob/1c1738716fa4cd758b0c26ec94d0873d1bc35ac1/crates/hark-app/src/overlay.rs#L1-L18)). All three surfaces are painted from the same main-thread egui context; the dictation pipeline (hotkey, audio, HTTP, injection) never touches egui directly and communicates only through channels and status snapshots.

Sources: [tray/mod.rs:1-14](https://github.com/BoardPandas/Hark/blob/1c1738716fa4cd758b0c26ec94d0873d1bc35ac1/crates/hark-app/src/tray/mod.rs#L1-L14), [ui/pages.rs:17-24](https://github.com/BoardPandas/Hark/blob/bcfcc3fef6f02252870fc3f06440d99992818ade/crates/hark-app/src/ui/pages.rs#L17-L24), [ui/shell.rs:179-184](https://github.com/BoardPandas/Hark/blob/bcfcc3fef6f02252870fc3f06440d99992818ade/crates/hark-app/src/ui/shell.rs#L179-L184), [overlay.rs:1-18](https://github.com/BoardPandas/Hark/blob/1c1738716fa4cd758b0c26ec94d0873d1bc35ac1/crates/hark-app/src/overlay.rs#L1-L18)
...
| Sidebar | `sidebar` | Fixed `184.0` px left panel: a Hark wordmark, nav rows for History/Spellbook/Stats, then Settings pinned above the version caption at the bottom ([shell.rs:13](https://github.com/BoardPandas/Hark/blob/1c1738716fa4cd758b0c26ec94d0873d1bc35ac1/crates/hark-app/src/ui/shell.rs#L13), [shell.rs:167-198](https://github.com/BoardPandas/Hark/blob/1c1738716fa4cd758b0c26ec94d0873d1bc35ac1/crates/hark-app/src/ui/shell.rs#L167-L198)) |
...
## History, Invocations, Stats and Settings

`ui::pages::Page` is the routing enum the shell's `CentralPanel` matches on; each page carries its own icon, nav label, and one-line description, and the content column narrows for the Settings form and widens for the list-style pages ([pages.rs:17-53](https://github.com/BoardPandas/Hark/blob/bcfcc3fef6f02252870fc3f06440d99992818ade/crates/hark-app/src/ui/pages.rs#L17-L53), [pages.rs:69-75](https://github.com/BoardPandas/Hark/blob/bcfcc3fef6f02252870fc3f06440d99992818ade/crates/hark-app/src/ui/pages.rs#L69-L75)):
...
| Spellbook | Book-open | "Names and terms your STT provider keeps missing." | 720 px |
| Invocations | Lightning | "Say a phrase, type a block of text you wrote." | 720 px |
...
The nav renders History, Spellbook, Invocations and Stats in order, with Settings pinned to the bottom above the version caption ([shell.rs:179-197](https://github.com/BoardPandas/Hark/blob/bcfcc3fef6f02252870fc3f06440d99992818ade/crates/hark-app/src/ui/shell.rs#L179-L197)).
...
`InvocationsPage` lists trigger-phrase to canned-text pairs and opens a full-page editor for one entry at a time; an open editor owns the whole page rather than reflowing the list under the cursor while a multi-line expansion grows ([invocations/mod.rs:42-48](https://github.com/BoardPandas/Hark/blob/bcfcc3fef6f02252870fc3f06440d99992818ade/crates/hark-app/src/ui/invocations/mod.rs#L42-L48)). The list is a plain `ScrollArea::vertical().show()` rather than `show_rows()`, because rows are non-uniform — a warning line appears only on entries that cannot fire ([invocations/mod.rs:83-95](https://github.com/BoardPandas/Hark/blob/bcfcc3fef6f02252870fc3f06440d99992818ade/crates/hark-app/src/ui/invocations/mod.rs#L83-L95)). Unlike the spellbook editor, it commits only on an explicit Save, never on `lost_focus`, because every commit runs `save_to_disk` plus a full pipeline restart ([invocations/editor.rs:1-8](https://github.com/BoardPandas/Hark/blob/bcfcc3fef6f02252870fc3f06440d99992818ade/crates/hark-app/src/ui/invocations/editor.rs#L1-L8)). Full detail lives on the [Invocations](INVOCATIONS.md) page.
...
Sources: [ui/pages.rs:1-160](https://github.com/BoardPandas/Hark/blob/bcfcc3fef6f02252870fc3f06440d99992818ade/crates/hark-app/src/ui/pages.rs#L1-L160), [ui/history/mod.rs:1-309](https://github.com/BoardPandas/Hark/blob/1c1738716fa4cd758b0c26ec94d0873d1bc35ac1/crates/hark-app/src/ui/history/mod.rs#L1-L309), [ui/invocations/mod.rs:1-302](https://github.com/BoardPandas/Hark/blob/bcfcc3fef6f02252870fc3f06440d99992818ade/crates/hark-app/src/ui/invocations/mod.rs#L1-L302), [ui/stats.rs:1-238](https://github.com/BoardPandas/Hark/blob/1c1738716fa4cd758b0c26ec94d0873d1bc35ac1/crates/hark-app/src/ui/stats.rs#L1-L238), [ui/settings/mod.rs:1-178](https://github.com/BoardPandas/Hark/blob/1c1738716fa4cd758b0c26ec94d0873d1bc35ac1/crates/hark-app/src/ui/settings/mod.rs#L1-L178)
